...
// const List<NigerianStock> nigerianStocks = [
//   NigerianStock(
//     symbol: 'AIRTELAFRI',
...
//   NigerianStock _selectedStock = nigerianStocks[7]; // GTCO default
//   final double _safetyIndex = 57.2;
...
//             child: Icon(Icons.person, color: Colors.brown[400], size: 26),
//           ),
...
//   // ─────────────────────────────────────────────
//   // Search Bar  — tappable, opens modal
//   // ─────────────────────────────────────────────
//   Widget _buildSearchBar(bool isDark) {
//     final changeIsPositive = _selectedStock.change.startsWith('+');
//     final changeIsNeutral = _selectedStock.change == '-';
...
//                   ),
//                   Text(
//                     '₦${_selectedStock.price.toStringAsFixed(2)}  •  Mkt Cap: ${_selectedStock.marketCap}',
...
//               mainAxisSize: MainAxisSize.min,
//               children: const [
//                 Icon(Icons.stop_circle, color: Color(0xFF7A5C00), size: 18),
//                 SizedBox(width: 8),
//                 Text(
//                   'HOLD',
//                   style: TextStyle(
...
//   // ─────────────────────────────────────────────
//   // Last 5 Days Bar Chart Card
//   // ─────────────────────────────────────────────
//   Widget _buildLast5DaysCard(bool isDark) {
//     final List<String> days = ['MON', 'TUE', 'WED', 'THU', 'FRI'];
//     final List<double> values = [42, 65, 58, 80, 50];

//     return Container(
//       padding: const EdgeInsets.all(20),
//       decoration: BoxDecoration(
//         color: isDark ? const Color(0xFF2A2D3E) : Color(0xFFF2F4F7),
//         borderRadius: BorderRadius.circular(20),
//         boxShadow: [
//           BoxShadow(
//             color: Colors.black.withOpacity(0.05),
...
//   // ─────────────────────────────────────────────
//   // Current Price Line Chart Card
//   // ─────────────────────────────────────────────
//   Widget _buildCurrentPriceCard(bool isDark) {
//     final List<FlSpot> spots = [
//       const FlSpot(0, 3.0),
//       const FlSpot(0.3, 2.9),
//       const FlSpot(0.6, 3.1),
//       const FlSpot(0.9, 3.0),
//       const FlSpot(1.2, 2.8),
//       const FlSpot(1.5, 2.5),
//       const FlSpot(1.8, 2.8),
//       const FlSpot(2.1, 3.3),
//       const FlSpot(2.4, 3.5),
//       const FlSpot(2.7, 3.2),
//       const FlSpot(3.0, 2.2),
//       const FlSpot(3.3, 1.8),
//       const FlSpot(3.6, 2.0),
//       const FlSpot(3.9, 2.3),
//       const FlSpot(4.2, 5.5),
//       const FlSpot(4.5, 6.2),
//       const FlSpot(4.6, 6.0),
//       const FlSpot(4.8, 5.5),
...
//                         color: isDark ? const Color(0xFF2A2D3E) : Colors.white,
//                         strokeWidth: 3,
//                         strokeColor: const Color(0xFF2979FF),
//                       ),
//                     ),
...
//   const _StockSearchModal({required this.isDark, required this.onSelected});
...
//   List<NigerianStock> _filtered = nigerianStocks;

//   void _onSearch(String query) {
//     setState(() {
//       _filtered = nigerianStocks.where((s) {
...
// // IMPORTANT: Update this import path to point to where you saved the ApiService!
...
//         // Parse the last 5 days for the charts
//         List<double> prices = [];
//         List<String> dates = [];
...
//           // Update the static model info so the top search bar matches
...
//             _fetchAIInsights(stock.symbol); // Fetch new AI data!
//           });
//           Navigator.pop(context);
//         },
//       ),
...
//   // Helper colors for dynamic UI
//   Color _getRecColor() {
//     if (_recommendation.contains("BUY")) return Colors.green;
//     if (_recommendation.contains("SELL")) return Colors.red;
//     return const Color(0xFF7A5C00); // Yellow
//   }

//   Color _getRecBgColor() {
//     if (_recommendation.contains("BUY")) return Colors.green.withOpacity(0.15);
//     if (_recommendation.contains("SELL")) return Colors.red.withOpacity(0.15);
//     return const Color(0xFFF5E6A3); // Light Yellow
//   }

//   IconData _getRecIcon() {
//     if (_recommendation.contains("BUY")) return Icons.trending_up;
//     if (_recommendation.contains("SELL")) return Icons.trending_down;
...
//                       PieChartSectionData(
//                         value: _safetyIndex,
//                         color: _getRecColor(), // Dynamic color!
//                         radius: 18,
//                         showTitle: false,
//                       ),
//                       PieChartSectionData(
...
//               mainAxisSize: MainAxisSize.min,
//               children: [
//                 Icon(_getRecIcon(), color: _getRecColor(), size: 18),
//                 const SizedBox(width: 8),
//                 Text(
//                   _recommendation,
//                   style: TextStyle(
...
//   // ─────────────────────────────────────────────
//   Widget _buildLast5DaysCard(bool isDark) {
//     // Dynamic Min/Max based on actual data to scale the chart beautifully
//     double maxPrice = _last5DaysPrices.reduce(max);
//     double minPrice = _last5DaysPrices.reduce(min);
//     double padding = (maxPrice - minPrice) * 0.2; // 20% padding
//     if (padding == 0) padding = maxPrice * 0.1; // Fallback for flat lines
...
//                 minY:
//                     maxPrice -
//                     (maxPrice * 0.5), // Lower the floor to make bars visible
//                 barTouchData: BarTouchData(enabled: false),
//                 titlesData: FlTitlesData(
//                   leftTitles: AxisTitles(
//                     sideTitles: SideTitles(showTitles: false),
...
//     // Map your historical prices to chart coordinates
//     List<FlSpot> spots = [];
...
//     if (padding == 0) padding = maxPrice * 0.05;
...
//                         end: Alignment.bottomCenter,
//                         colors: [
//                           _getRecColor().withOpacity(0.2),
//                           _getRecColor().withOpacity(0.0),
//                         ],
//                       ),
//                     ),
//                   ),
  ...
  Future<void> _fireNotifications(double safetyIdx, String changeStr) async {
    ...
    if (box.get('notif_ai_forecast', defaultValue: true) == true) {
      await provider.addNotification(
        ...
        body:
            'New forecast for ${_selectedStock.symbol}: $_recommendation',
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          showModalBottomSheet(
            ...
            isScrollControlled: true,
            backgroundColor: Colors.transparent,
            builder: (context) => AiChatSheet(isDark: isDark, currentTicker: _selectedStock.symbol,),
          );
        },
      ),
      bottomNavigationBar: const BottomNavBar(currentIndex: 0),
